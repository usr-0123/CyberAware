...
export const { useCreateNewQuizMutation, useGetAllQuizQuery, useGetQuizByQuizIdQuery, useGetQuizbyUseridQuery, useGetQuizByQuestionidQuery, useUpdateQuizMutation, useDeleteQuizMutation } = quizApi;